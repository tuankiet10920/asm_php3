<template>
    ...
    <img src="..../../../public/assets/img/spinner.svg" alt="Spinner loader">
</div> -->
        <!-- Hero -->
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-7">
                        ...
                        <a class="btn btn-primary" href="#apply">Đăng ký <i class="fas fa-angle-right ml-2"></i> </a>
                    </div>
                    <div class="col-12 col-md-5 d-none d-lg-block text-center">
                        <img src="../../../public/assets/img/carousel/teacher.png" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                        <div class="card bg-primary p-4">
                            <div class="icon icon-lg justify-content-start mb-3">
                                <span class="icon icon-secondary icon-lg mb-3">
                                    <div class="image-md">
                                        <img src=../../../public"assets/img/illustrations/guarantee.png" alt="">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                        <div class="card bg-primary p-4">
                            <div class="icon icon-lg justify-content-start mb-3">
                                <span class="icon icon-secondary icon-lg mb-3">
                                    <div class="image-md">
                                        <img src=../../../public"assets/img/illustrations/flexible.png" alt="">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card bg-primary p-4">
                            <div class="icon icon-lg justify-content-start mb-3">
                                <span class="icon icon-secondary icon-lg mb-3">
                                    <div class="image-md">
                                        <img src=../../../public"assets/img/illustrations/money.png" alt="">
                                    </div>
                                </span>
                            </div>
                ...
                <div class="row justify-content-center mb-4 mb-lg-6">
                    <div class="col col-md-8 text-center">
                        <h2 class="display-1 font-weight-extreme px-lg-5"
                            ...
                            <div>Lớp trống đang chờ gia sư</div>
                        </h2>
                                    ...
                                    <div class="col-12 col-md-6 mb-4 mb-lg-0">
                                        ...
                                        <div class="d-flex">
                                            <a href="#" class="stretched-link">
                                                ...
                                                <span class="h6 text-sm ml-2">Hồ
                                                    Chí Minh</span>
                                            </a>
                                            <span class="ml-4">
                                                <i class="fas fa-user-tie"></i>
                                                <span class="h6 text-sm ml-2">Sinh
                                                    viên</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-md-end">
                                        <a href="#apply" class="btn btn-secondary mr-3 animate-up-2 m-0">Ứng
                                            tuyển</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="firstName">Tên <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-user-alt"></i></span></div>
                                            <input class="form-control" id="firstName" placeholder="Hải" type="text"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="lastName">Họ và tên đệm
                                            <span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-user-alt"></i></span></div>
                                            <input class="form-control" id="lastName" placeholder="Nguyễn Quang"
                                                type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="email">Email <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-envelope"></i></span></div>
                                            <input class="form-control" id="email" placeholder="bookbook.ltd@gmail.com"
                                                type="email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="phone">Số điện
                                            thoại<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-phone-square-alt"></i></span></div>
                                            <input class="form-control" id="phone" placeholder="090****123"
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="address">Địa chỉ<span
                                                class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-phone-square-alt"></i></span></div>
                                            <input class="form-control" id="address" placeholder="90 le vinh hoa"
                                                type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="sex">Giới tính<span
                                                class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-male"></i></span></div>
                                            <input class="form-control" id="sex" placeholder="nam" type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="score">Điểm thi đại
                                            học<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-copy"></i></span></div>
                                            <input class="form-control" id="score" placeholder="Khối - điểm - năm thi"
                                                type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="university">Trường đại
                                            học bạn đã/đang học<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-university"></i></span></div>
                                            <input class="form-control" id="university"
                                                placeholder="Đại học Bách Khoa, tp.Hồ Chí Minh" type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="experience">Kinh nghiệm
                                            dạy gia sư<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-chalkboard-teacher"></i></span></div>
                                            <input class="form-control" id="experience" placeholder="không/có - 3 năm "
                                                type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="desired-subjects">Bạn
                                            mong muốn dạy môn gì? lớp
                                            mấy?<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-chalkboard-teacher"></i></span></div>
                                            <input class="form-control" id="desired-subjects"
                                                placeholder="Môn toán - lớp 12, môn hoá - lớp 11" type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="tuitor-fee">Mức lương
                                            mà bạn mong muốn cho một
                                            buổi học<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-dollar-sign"></i></span></div>
                                            <input class="form-control" id="tuitor-fee" placeholder="100.000 vnd"
                                                type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-12 mt-lg-4">
                                    <div class="form-group">
                                        <label class="form-label text-muted" for="achievements">Thành
                                            tích nổi bật của bạn<span class="text-danger">*</span></label>
                                        <div class="input-group mb-4">
                                            <textarea id="achievements" class="form-control"
                                                placeholder="Giải nhất học sinh giỏi cấp thành phố - 2019" rows="8"
                                                required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <textarea id="message" class="form-control" placeholder="Làm thế nào mình có thể kết nối được với học viên?" rows="8" required></textarea>
                                    ...
                                    <div class="text-lg-center mb-2">
                                        <button type="submit" class="btn btn-primary animate-up-2 mt-4"><span
                                                class="mr-2"><i class="fas fa-paper-plane"></i></span>Gửi
                                            thông tin</button>
                                    </div>
                                </div>
                            </div>
