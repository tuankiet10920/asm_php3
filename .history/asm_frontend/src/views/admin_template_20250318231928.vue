...
const hrefhrefs = [
    ...
    "../assets/css/argon-dashboard.css?v=2.1.0"
]
for (let index = 0; index < hrefhrefs.length; index++) {
    let link = document.createElement('link')
    link.rel = relrels
    link.href = hrefhrefs['index']
    if(index == hrefhrefs.length - 1){
        link.id = "pagestyle"
    }
}
</script>
