...
onMounted(() => {
    ...
    const xxxxxx = [
        ...
        "../../../public/admin/assets/css/argon-dashboard.css?v=2.1.0"
    ]
    for (let index = 0; index < xxxxxx.length; index++) {
        let link = document.createElement('link')
        link.rel = xxxxx
        link.href = xxxxxx[index]
        if (index == xxxxxx.length - 1) {
            link.id = "pagestyle"
        }
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="../../../public/admin/assets/img/logo-ct-dark.png" width="26px" height="26px" class="navbar-brand-img h-100"
                    alt="main_logo">
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-plain shadow-none" id="sidenavCard">
                <img class="w-50 mx-auto" src="../../../public/admin/assets/img/illustrations/icon-documentation.svg"
